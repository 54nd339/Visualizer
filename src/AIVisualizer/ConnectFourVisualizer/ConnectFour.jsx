        ...
        return (
            <div>
                <div className="game">
                    ...
                    {buttons}
                    <img id="loadingImgT" className="loadingImgT" src={loading} height="100px" width="100px" style={{ marginLeft: "10px", position: "absolute", zIndex: 0 }} alt></img>;
                    <div>
                        <h5 class="connectFourDes" style={{ position: "absolute", marginTop: "160px", marginLeft: "30px", textAlign: "left" }}>
                            This is a 2-player game known as "Connect Four", which you<br />
